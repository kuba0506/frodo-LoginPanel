    ...
    Frodo.prototype.init = function() {
        ...
        var config = this.config,
            ...
            el = {
                ...
                //Main elemenets
                wrapper: $('<div/>', {
                    id: config.frodoWrapper
                }),
                overlay: $('<div/>', {
                    class: config.frodoOverlay
                }),
                frodo: $('<div/>', {
                    id: config.frodo,
                    class: config.frodo
                ...
                //Header
                header: $('<h3/>', {
                    class: config.frodoHeader.header
                }),
                headerTxt: $('<span/>', {
                    class: config.frodoHeader.text,
                    html: config.loginTxt
                }),
                closeBtn: $('<button/>', {
                ...
                loginFooter: $('<div/>', {
                    class: config.frodoLogin.footer
                }),
                frodoLinksWrapper: $('<div/>', {
                    class: config.frodoLogin.linksWrapper
                }),
                forgotLink: $('<a/>', {
